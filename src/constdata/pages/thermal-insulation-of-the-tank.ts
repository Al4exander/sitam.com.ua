...
export const thermalInsulationOfTheTank = {
    ...
    manufacturers: {
        text: 'На данный момент ООО «СИТАМ» имеет большой опыт утепления резервуаров самых разных марок и конфигураций. В списке оборудования, с которым мы работаем, числятся агрегаты следующих производителей: РГС и других производителей в т.ч. отечественных',
    },
