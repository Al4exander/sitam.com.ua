...
export const bendingPress = {
    ...
    underTitle: '«Sitam» Выполним ремонт и обслуживание гидравлического листогибочного пресса и другого промышленного прессового оборудования на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства.',
    firstImage,
    secondImage,
    firstText: {
