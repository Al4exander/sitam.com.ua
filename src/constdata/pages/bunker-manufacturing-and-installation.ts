...
export const bunkerManufacturingAndInstallation = {
    ...
    keywords: 'ремонт,ремонт,бункер,транспортное,оборудование,зернохранилище,силос',
    firstText: {
    ...
    secondText: {
        text: `Изготовим и произведем монтаж стального бункера для хранения сыпучих материалов: зерна, муки, комбикорма, строительных смесей, различных удобрений, цемента, песка, извести, гравия, щебня, угля, руды, кокса и прочих сыпучих веществ и материалов.
