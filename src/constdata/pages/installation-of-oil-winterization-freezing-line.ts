...
export const installationOfOilWinterizationFreezingLine = {
    ...
    description: 'Спроектируем, изготовим и смонтируем комплексы периодического действия для вымораживания (винтеризации) рафинированных прессовых растительных масел. Монтаж кристаллизатора. Монтаж насосов для перекачки масла. Монтаж резервуаров',
    secondText: {
