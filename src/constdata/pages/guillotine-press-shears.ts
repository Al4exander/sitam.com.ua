...
export const guillotinePressShears = {
    ...
    secondImage,
    manufacturers: {
        text: 'На данный момент «Sitam» имеет большой опыт ремонта гильотинных ножниц самых разных марок и конфигураций. В списке оборудования, с которым мы работаем, числятся агрегаты следующих производителей: Akros, Yangli QC12, NC E200 и других производителей (в т.ч. отечественных)',
    },
    underTitle: `«Sitam» Ремонтируем гильотины, пресс ножницы и гидравлику на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства`,
