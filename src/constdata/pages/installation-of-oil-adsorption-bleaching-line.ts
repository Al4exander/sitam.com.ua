...
export const installationOfOilAdsorptionBleachingLine = {
    ...
    description: 'монтаж линии адсорбции (отбеливания) масла различных культур, таких как соевое масло, арахисовое масло, подсолнечное масло, масло семян рапса, кокосовое масло, пальмовое масло и т.д',
    secondText: {
