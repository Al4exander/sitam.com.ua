...
export const modernizationOfTheShearPress = {
    ...
    manufacturers: {
        text: '«Sitam» имеет большой опыт ремонта и модернизации пресс ножниц и прессов для пакетирования металлолома самых разных марок и конфигураций. В списке оборудования, с которым мы работаем, числятся агрегаты следующих производителей: Akros, Riko, Metso Lindemann, SIERRA, HuaHong, Enerpat, WANSHIDA, Dongfang и других производителей в т.ч. отечественных',
    },
    title: 'Модернизация пресс ножниц',
    underTitle: '«Sitam»  Выполним модернизацию пресс ножниц и другого промышленного оборудования на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства',
    firstImage,
    secondImage,
    firstText: {
