...
export const sugarFactories = {
    ...
    keywords: 'строительство,завод,сахар,монтаж,транспортёрная,бункер,мешалка',
    firstText: {
...
Мотаж грабельного транспортёра;
...
Демонтаж шнеков с замененой витков и изготовлением новых спиц;
