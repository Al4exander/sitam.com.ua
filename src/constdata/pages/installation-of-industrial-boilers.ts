...
export const installationOfIndustrialBoilers = {
    ...
    secondImage,
    manufacturers: {
        text: 'На данный момент «Sitam» имеет большой опыт монтажу или демонтажу котлов самых разных марок и конфигураций. В списке оборудования, с которым мы работаем, числятся агрегаты следующих производителей: Е, ДЕ, КЕ, ДКВр, КСВа, ВК, КВГ, ТВГ и других производителей в т.ч. отечественных',
    },
    underTitle: `«Sitam» Выполним монтаж котлов и другого промышленного котельного оборудования на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства`,
