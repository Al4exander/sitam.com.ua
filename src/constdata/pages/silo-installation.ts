...
export const siloInstallation = {
    ...
    underTitle: `«Sitam» Выполняем монтаж силоса и транспортного оборудования зернохранилища силосного типа на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства
