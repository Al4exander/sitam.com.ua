...
export const cranePainting = {
    ...
    secondImage,
    manufacturers: {
        text: 'На данный момент ООО «СИТАМ» имеет большой опыт покраски козловых кранов самых разных марок и конфигураций. В списке оборудования, с которым мы работаем, числятся агрегаты следующих производителей: КК, ККС, ККТ, КДКК и других производителей в т.ч. отечественных.',
    },
