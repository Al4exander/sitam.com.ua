...
export const dismantlingOfMachines = {
    ...
    underTitle: `«Sitam» Выполним демонтаж станков и другого промышленного оборудования на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства.`,
    firstText: {
