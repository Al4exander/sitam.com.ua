...
export const wastePaperPress = {
    ...
    underTitle: '«Sitam» Выполним ремонт и обслуживание гидравлического пресса для макулатуры и вторсырья и другого промышленного прессового оборудования на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства',
    firstImage,
    secondImage,
    firstText: {
