...
export const disassemblyInstallationOfMiscellaDistiller = {
    ...
    manufacturers: {
        text: 'Компания «Sitam» имеет большой опыт ремонта дистилляторов самых разных марок и конфигураций. В списке оборудования, с которым мы работаем, числятся агрегаты следующих производителей: Alfa Laval, Bernardini, Andreotti, Westfalia и других производителей в т.ч. отечественных.'
    },
    firstText: {
        text: `«Sitam» Устанавливаем дистилляторы и другое промышленное оборудование на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства.
