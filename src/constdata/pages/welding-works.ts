...
export const weldingWorks = {
    ...
    secondImage,
    manufacturers: {
        text: 'На данный момент «Sitam» имеет большой опыт сварки и изготовление металлоконструкций самых разных конфигураций. В списке оборудования, с которым мы работаем, числятся агрегаты следующих производителей: Bock, Bitzer, Copeland, Maneurop, DVK и других производителей в т.ч. отечественных',
    },
    underTitle: `«Sitam» Выполним сварочные работы и изготовление металлоконструкций на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства`,
