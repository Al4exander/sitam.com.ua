...
export const installationOfTechnologicalLines = {
    ...
    manufacturers: {
        text: 'На данный момент ООО «СИТАМ»  имеет большой опыт монтажа производственных линий различных конфигураций: агрегатно-поточные линии, поточные технологические линии(Конвейерные).',
    },
