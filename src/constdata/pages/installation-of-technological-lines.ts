...
export const installationOfTechnologicalLines = {
    ...
    manufacturers: {
        text: 'На данный момент «Sitam»  имеет большой опыт монтажа производственных линий различных конфигураций: агрегатно-поточные линии, поточные технологические линии(Конвейерные).',
    },
    title: 'Монтаж технологических линий',
    underTitle: '«Sitam» Выполним монтаж технологических линий, конвейеров, транспортеров, инженерных и технологических систем, и другого технологического оборудования промышленного производства на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства.',
    firstImage,
    secondImage,
    firstText: {
