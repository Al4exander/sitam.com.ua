...
export const compressorInstallation = {
    ...
    secondImage,
    manufacturers: {
        text: 'На данный момент ООО «СИТАМ» имеет большой опыт монтажу и демонтажу компрессоров самых разных марок и конфигураций. В списке оборудования, с которым мы работаем, числятся агрегаты следующих производителей: Bock, Bitzer, Copeland, Maneurop, DVK и других производителей в т.ч. отечественных',
    },
