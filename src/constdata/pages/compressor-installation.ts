...
export const compressorInstallation = {
    ...
    secondImage,
    manufacturers: {
        text: 'На данный момент «Sitam» имеет большой опыт монтажу и демонтажу компрессоров самых разных марок и конфигураций. В списке оборудования, с которым мы работаем, числятся агрегаты следующих производителей: Bock, Bitzer, Copeland, Maneurop, DVK и других производителей в т.ч. отечественных',
    },
    underTitle: `«Sitam» Выполним монтаж компрессора и другого промышленного холодильного оборудования на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства`,
