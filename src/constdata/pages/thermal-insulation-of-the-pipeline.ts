...
export const thermalInsulationOfThePipeline = {
    ...
    manufacturers: {
        text: '«Sitam» имеет большой опыт монтажа и замены теплоизоляции трубопровода самых разных марок и конфигураций. В списке оборудования, с которым мы работаем, числятся агрегаты следующих производителей: Е, КСВа (ЭКО), ВК, КВГ, ТВГ, КСВ и других производителей в т.ч. отечественных',
    },
    title: 'Монтаж теплоизоляции технологического трубопровода',
    underTitle: '«Sitam» Выполним ремонт и монтаж теплоизоляции трубопровода и другого промышленного оборудования на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства',
    firstImage,
    secondImage,
    firstText: {
