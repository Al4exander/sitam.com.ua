...
export const cycloneInstallation = {
    ...
    underTitle: `«Sitam» Выполним ремонт, монтаж циклонов, аспирационных систем и другого оборудования для фильтрации на профессиональном уровне. На все виды работ организация имеет необходимые разрешения и свидетельства.`,
    firstText: {
        text: `### Монтаж циклона
