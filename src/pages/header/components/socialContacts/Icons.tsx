...
export const Icons: React.FC<IIcons> = ({className, iconClassName}) => {
    return (
        <div className={className}>
            <a className={iconClassName} target='_blank' rel='noopener noreferrer' href='viber://chat?number=380666951098' title={'Viber'}>
            ...
            <a className={iconClassName} target='_blank' rel='noopener noreferrer' href='https://wa.me/+380666951098?text=Доброго дня,%20я%20стосовно' title={'Whatsapp'} >
