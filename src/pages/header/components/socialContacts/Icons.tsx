...
export const Icons = ({ className, iconClassName }: IIcons) => {
    return (
        <>
            <div className={className}>
                ...
                <a href='https://t.me/Sitam_LLC' target='_blank' rel='noopener noreferrer' className={iconClassName}
                   title={'Telegram'}>
                    <img className='header-icon' src={telegram} title={'Telegram'} alt={'Telegram'} loading='lazy' />
                </a>
                <a className={iconClassName} target='_blank' rel='noopener noreferrer'
                   href='https://wa.me/+380676951098?text=Доброго дня,%20я%20стосовно' title={'Whatsapp'}>
